...
export const MOCK_VENDORS: Vendor[] = [
    // --- Fotógrafos ---
    { id: 'momentos-inolvidables-fotografia', name: 'Momentos Inolvidables Fotografía', email: 'contacto@momentosinolvidables.cl', registeredDate: '2023-01-15T10:00:00Z', status: 'Aprobado', category: 'Fotógrafos', location: 'Providencia, Metropolitana de Santiago', city: 'Providencia', rating: 4.9, description: 'Capturamos la esencia de tu amor con un estilo natural y emotivo.', imageUrl: 'https://images.unsplash.com/photo-1542042161-d10f8a84d872?q=80&w=400&h=300&auto-format&fit=crop', startingPrice: 550000 },
